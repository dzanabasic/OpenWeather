...
public class WeatherFull {
	...
	public String toString() {
		return "WeatherFull{" + "coord=" + coord + ", sys=" + sys + ", weather=" + weather + ", base=" + base + ", main=" + main + ", wind=" + wind + ", clouds=" + clouds + ", dt=" + dt + ", id=" + id + ", name=" + name + ", cod=" + cod + '}';
	}
	...
	public WeatherFull(Coord coord, Sys sys, Weather[] weather, String base, Main main, Wind wind, Clouds clouds, long dt, long id, String name, int cod) {
		this.coord = coord;
		this.sys = sys;
		this.weather = weather;
		this.base = base;
